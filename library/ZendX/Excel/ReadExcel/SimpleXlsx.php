...
class ZendX_Excel_ReadExcel_SimpleXLSX {
...
//			$bE = ($aP['GPF'] && 0x0001) ? TRUE : FALSE;
    ...
    function _parse() {
        ...
        foreach ($relations->Relationship as $rel) {
            if ($rel["Type"] == ZendX_Excel_ReadExcel_SimpleXLSX::SCHEMA_OFFICEDOCUMENT) {
                ...
                $workbookRelations->registerXPathNamespace("rel", ZendX_Excel_ReadExcel_SimpleXLSX::SCHEMA_RELATIONSHIP);

                // Read shared strings
                $sharedStringsPath = $workbookRelations->xpath("rel:Relationship[@Type='" . ZendX_Excel_ReadExcel_SimpleXLSX::SCHEMA_SHAREDSTRINGS . "']");
                ...
                foreach ($workbookRelations->Relationship as $workbookRelation) {
                    if ($workbookRelation["Type"] == ZendX_Excel_ReadExcel_SimpleXLSX::SCHEMA_WORKSHEETRELATION) {
