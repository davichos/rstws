...
class ZendX_Action_Helper_Admin_Datagridadmin extends Zend_Controller_Action_Helper_Abstract {
    ...
    private function _setEnhancedgrid($id = null, $idgridiv = null) {
        ...
        $enhancedgrid .= "plugins:{indirectSelection:{headerSelector:true, width:'40px', styles:'text-align: center;'},exporter:true,pagination:{pageSizes: ['25', '50', '100', 'All'],description:true,sizeSwitch:";
